...
<style>
    ...
    #mascota_registration_form > div > div:nth-child(5) > div > i {
        margin-right: 110px;
    }
    ...
    #mascota_registration_form > div > div:nth-child(5) > div > div > button {
        width: 270px;
    }
...
<form action="${createLink(controller:'user', action:'createUser')}" method="post"  id="mascota_registration_form">
    <div class="mx-auto" style="width: 500px; background-color: #f8f9fa; margin-top: 20px">
        ...
        <label id="charNum" style="margin-left: 140px;font-size: 10px;color: grey;"> Descripcion: 140</label>
            <div class="input-group">
                <label class="col-md-3 control-label">
                    ...
                    <textarea style="height: 120px; width: 270px; flex: none" placeholder="Ingrese una descripcion de su mascota." name="descripcion" maxlength="140" class="form-control" id="exampleTextarea" rows="3" onkeyup="countChar(this)" name="descripcion" required></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input type="submit" style="margin-top: 30px" class="btn btn-info btn-block form-control col-md-6" type="submit" value="Registrarse"/>
            </div>
        </div>
    </div>
</form>
